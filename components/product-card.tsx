...
export function ProductCard({ title, price, img, tag, description, id = 1 }: Props) {
  ...
  return (
    ...
    >
      <Card
        className={
          "relative overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 p-0 border border-[#e0d5c7] bg-white hover:border-emerald-500/50 dark:border-white/10 dark:bg-linear-to-br dark:from-[#1f1f1f] dark:to-[#2a2a2a] dark:hover:shadow-emerald-500/10 dark:hover:border-emerald-500/30"
        }
      ...
      >
        ...
        <div
          className={
            "relative aspect-square overflow-hidden rounded-t-xl bg-[#f5f0ea] dark:bg-black/40"
          }
        >
          <motion.div
        ...
        >
          <h3
            className={
              "text-xl sm:text-xl font-inter font-semibold mb-1 text-[#2d2520] dark:text-white"
            }
          >
            {title}
          </h3>
          <p
            className={
              "text-xs sm:text-base mb-3 sm:mb-4 text-neutral-600 dark:text-neutral-400"
            }
          >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <motion.div
              className={
                "text-lg sm:text-2xl font-cinzel font-bold text-[#2d2520] dark:text-emerald-400"
              }
